...
?>
    ...
    <body>
        ...
        <div class="page">
            ...
            <div>
                <h1 class="ari">Previous Record Of Chamber ID = <?php echo $chamber; ?></h1>
...
<div class="table-responsive">
                    ...
                    <Table style=" margin: 0 auto; ">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-dark" name="search">Search
                                </button>
                            </td>
                        </tr>
                    </Table>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "SELECT * FROM stream_chamber WHERE Date = '$date' and Time = '$time'";
                    ...
                    $q = "SELECT * FROM stream_chamber WHERE Date = '$date' and Time = '$time'";
                    $result = mysqli_query($mysqli, $q);
                    $res = mysqli_fetch_all($result, MYSQLI_ASSOC);
                ?>
                    <?php
