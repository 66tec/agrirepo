    ...
    <div class="page">
                ...
                <div class="container-fluid">
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <!-- Log out-->
                            <li class="nav-item"><a href="admin_logout.php" class="nav-link logout"> <span class="d-none d-sm-inline-block">Logout</span><i class="fa fa-sign-out"></i></a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <main>
            ...
            <div class="newArrivals">
                <h1 class="ari">List Of Purchase Invest</h1>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-cell"> <button class="btn btn-success" style="width: 100px;height: 30px;background-color: #314755;border: black;color: white"> <a href="admin_stream_client.php?<?php echo $row['Id']; ?>"> Details </a> </button> </td>

                            <td class="table-cell"> <button class="btn btn-success" style="width: 100px;height: 30px;background-color: #314755;border: black;color: white"> <a href="admin_stream_invest.php?<?php echo $row['Id']; ?>"> Stream </a> </button> </td>
                            <td class="table-cell"> <button class="btn btn-success" style="width: 100px;height: 30px;background-color: #314755;border: black;color: white"> <a href="admin_previous_invest.php?<?php echo $row['Id']; ?>"> Record </a> </button> </td>
