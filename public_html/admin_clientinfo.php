        ...
        <div class="side-navbar-wrapper">
            ...
            <div class="sidenav-header d-flex align-items-center justify-content-center">
                ...
                <div class="sidenav-header-inner text-center"><i style="font-size: xxx-large; color: #33b35a ;" class="fa fa-user-circle img-fluid rounded-circle" aria-hidden="true"></i>
                    <h2 class="h5">Welcome Admin<?php// echo $login_session; ?></h2>
                </div>
    ...
    <div class="page">
        ...
        <main>
            ...
            <div class="newArrivals">
                <h1 class="ari">List Of Client Details</h1>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr class="table-row">
                            ...
                            <!-- <td class="table-cell"> <button class="btn btn-success" style="width: 100px;height: 30px;background-color: #314755;border: black;color: white" > <a href="stream_chamber.php?<?php echo $row['Chamber_id']; ?>" > Stream </a>  </button> </td> -->
                            <!-- <td class="table-cell"> <button class="btn btn-success" style="width: 100px;height: 30px;background-color: #314755;border: black;color: white" > <a href="Previous_chamber.php?<?php echo $row['Chamber_id']; ?>" > Record </a>  </button> </td> -->
