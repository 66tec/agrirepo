...
<div class="sidenav-header-inner text-center"><i style="font-size: xxx-large; color: #33b35a ;" class="fa fa-user-circle img-fluid rounded-circle" aria-hidden="true"></i>
          ...
          <h2 class="h5">Welcome <?php echo $login_session1; ?></h2>
        </div>
        <!-- Small Brand information, appears on minimized sidebar-->
        <div class="sidenav-header-logo"><a href="indexfinal.php" class="brand-small text-center"> <strong><?php echo strtoupper(substr($login_session1, 0, 1))
  ...
  <div class="page">
        ...
        <div class="container-fluid">
          <div class="navbar-holder d-flex align-items-center justify-content-between">
            <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="indexfinal.php" class="navbar-brand">
                <div class="brand-text d-none d-md-inline-block"><span><?php echo $login_session1; ?> &nbsp; </span><strong class="text-primary"> Dashboard</strong></div>
              </a></div>
    ...
    <div class="newArrivals">
                <h1 class="ari">Total Services Our Clients Using</h1>
            </div>
      <div class="cards" style="margin-top: 22;">
        <div class="card-single">
          <div>
            <h1><?php echo $chamber_count_total?></h1>
            <span>Chambers</span>
          </div>
          <div>
        ...
        <div class="card-single">
          <div>
            <h1><?php echo $chamber_invest_total?></h1>
            <span>Invest</span>
          </div>
          <div>
        ...
        <div class="card-single">
          <div>
            <h1><?php echo $chamber_farm_total?></h1>
            <span>Farming</span>
          </div>
          <div>
