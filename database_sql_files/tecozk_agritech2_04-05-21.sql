...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2021 at 08:58 PM
...
(12, 'bbb', 'bbb', 'bbb', 'bbbb', '2021-05-01 20:57:10', 'Inactive', 'admin'),
...
(1, 'admin', 'admin', 'admin', 'admin', 'active', 'user', '5/1/2021, 9:07:18 PM'),
...
INSERT INTO `zone` (`zone_id`, `zone_name`, `user_name`) VALUES
(5, 'ccccc', 'admin');
...
--
ALTER TABLE `component`
  MODIFY `component_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
