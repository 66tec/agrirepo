...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2021 at 02:11 AM
...
INSERT INTO `chamber` (`chamber_id`, `chamber_name`, `chamber_disp_name`, `user_name`, `zone_name`, `farm_name`) VALUES
(1, 'addsdas', 'sdaad', 'admin', '', ''),
(2, 'cc', 'cc', 'admin', 'ccccc', 'ccc'),
(3, 'hhh', 'hhh', 'admin', 'hhh', 'hhh');
...
INSERT INTO `component` (`component_id`, `component_name`, `component_disp_name`, `component_master_type`, `component_type`) VALUES
(1, 'kkk', 'kkkk', 'Actuator', 'Soil Moisture'),
(2, '1', '1', 'Actuator', 'Soil Moisture'),
(3, 'hhh', 'hhh', 'Actuator', 'Soil Moisture');
...
(13, 'ccc', 'cccc', 'cccc', 'cccc', '2021-05-01 21:00:54', 'Inactive', 'admin'),
(25, 'aa', 'aa', 'aa', 'aa', '2021-05-05 01:14:32', 'Inactive', ''),
(26, 'ddd', 'ddd', 'ddd', 'ddd', '2021-05-05 02:42:48', 'Inactive', 'admin'),
(27, 'farm 1', '300', '300', 'karachi', '2021-05-05 04:26:09', 'Inactive', 'admin'),
(28, 'ggg', 'ggg', 'ggg', 'ggg', '2021-05-05 04:27:45', 'Inactive', 'admin'),
(29, 'hhh', 'hhh', 'hhh', 'hhh', '2021-05-05 04:29:33', 'Inactive', 'admin');
...
(1, 'admin', 'admin', 'admin', 'admin', 'active', 'user', '5/5/2021, 5:06:12 AM'),
...
INSERT INTO `zone` (`zone_id`, `zone_name`, `user_name`, `farm_name`) VALUES
(5, 'ccccc', 'admin', ''),
(15, 'aa', '', ''),
(16, 'adadad', 'admin', 'bbb'),
(17, 'ggg', 'admin', 'ggg'),
...
--
ALTER TABLE `chamber`
  MODIFY `chamber_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `component`
  MODIFY `component_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `farm`
--
ALTER TABLE `farm`
  MODIFY `farm_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `zone`
  MODIFY `zone_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
